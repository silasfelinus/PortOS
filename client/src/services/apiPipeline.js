...
// `mode`: 'merge' (default) augments existing comments; 'fresh' clears prior
// open/accepted comments and shows only this run's findings (kept dismissals
// still suppress resurfacing).
