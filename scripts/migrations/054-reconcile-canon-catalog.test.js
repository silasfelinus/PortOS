/**
 * Migration 054 is a REGISTRATION STUB — the actual canon↔catalog reconcile
...
import migration from './054-reconcile-canon-catalog.js';

describe('migration 054 — reconcile-canon-catalog (registration stub)', () => {
