...
import migration from './101-editorial-dead-metaphor-stage.js';
...
const BODY = '# Dead / mixed metaphor\n\nshipped body\n';

describe('migration 101 — seed editorial-dead-metaphor stage', () => {
  let rootDir;
  let stagesDir;
  let refStagesDir;
  ...
  beforeEach(() => {
    rootDir = mkdtempSync(join(tmpdir(), 'migration-101-'));
