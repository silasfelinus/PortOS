...
import migration from './104-editorial-mirror-description-stage.js';
...
const FILENAME = 'pipeline-editorial-mirror-description.md';
const STAGE_KEY = 'pipeline-editorial-mirror-description';
const BODY = '# Mirror self-description\n\nshipped body\n';

describe('migration 104 — seed editorial-mirror-description stage', () => {
  let rootDir;
  let stagesDir;
  let refStagesDir;
  ...
  beforeEach(() => {
    rootDir = mkdtempSync(join(tmpdir(), 'migration-104-'));
