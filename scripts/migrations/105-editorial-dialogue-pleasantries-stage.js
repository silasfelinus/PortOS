/**
 * Seed the `pipeline-editorial-dialogue-pleasantries` stage into existing installs (#1300).
 *
 ...
 * running `update.sh`) would otherwise leave the new dialogue-pleasantries stage
 * unseeded and the `dialogue.pleasantries` editorial check would throw "Stage not
