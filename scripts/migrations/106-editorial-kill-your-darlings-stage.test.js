...
import migration from './106-editorial-kill-your-darlings-stage.js';
...
const FILENAME = 'pipeline-editorial-kill-your-darlings.md';
const STAGE_KEY = 'pipeline-editorial-kill-your-darlings';
const BODY = '# Kill your darlings\n\nshipped body\n';

describe('migration 106 — seed editorial-kill-your-darlings stage', () => {
  let rootDir;
  let stagesDir;
  let refStagesDir;
  ...
  beforeEach(() => {
    rootDir = mkdtempSync(join(tmpdir(), 'migration-106-'));
