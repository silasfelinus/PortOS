...
import migration from './110-editorial-telling-emotion-stage.js';
...
const BODY = '# Telling-not-showing emotion\n\nshipped body\n';

describe('migration 110 — seed editorial-telling-emotion stage', () => {
  let rootDir;
  let stagesDir;
  let refStagesDir;
  ...
  beforeEach(() => {
    rootDir = mkdtempSync(join(tmpdir(), 'migration-110-'));
