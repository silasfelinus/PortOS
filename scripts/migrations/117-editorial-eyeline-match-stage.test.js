...
import migration from './117-editorial-eyeline-match-stage.js';

// scripts/migrations/<this> → ../.. is the repo root (matches _testHelpers.js).
const repoRoot = join(dirname(fileURLToPath(import.meta.url)), '..', '..');

// First-shipment seed migration (mirrors 116) — no MD5 bookkeeping, so the
...
const BODY = '# Pipeline — Editorial Check: Storyboard eyeline match\n\nshipped body\n';

describe('migration 117 — seed editorial-eyeline-match stage', () => {
  let rootDir;
  let stagesDir;
  let refStagesDir;
