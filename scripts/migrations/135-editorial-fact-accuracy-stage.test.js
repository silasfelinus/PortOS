...
import migration from './135-editorial-fact-accuracy-stage.js';

// scripts/migrations/<this> → ../.. is the repo root (matches _testHelpers.js).
const repoRoot = join(dirname(fileURLToPath(import.meta.url)), '..', '..');

// First-shipment seed migration (mirrors 134) — no MD5 bookkeeping, so the
// seed / no-clobber behavior is asserted directly.

const FILENAME = 'pipeline-editorial-fact-accuracy.md';
const STAGE_KEY = 'pipeline-editorial-fact-accuracy';
const BODY = '# Research / fact accuracy\n\nshipped body\n';

describe('migration 135 — seed editorial-fact-accuracy stage', () => {
  let rootDir;
  let stagesDir;
  let refStagesDir;
