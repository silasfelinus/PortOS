...
import migration from './140-editorial-pacing-escalation-stage.js';
...
const BODY = '# Pacing / intensity escalation curve\n\nshipped body\n';

describe('migration 140 — seed editorial-pacing-escalation-curve stage', () => {
  let rootDir;
  let stagesDir;
  let refStagesDir;
  ...
  beforeEach(() => {
    rootDir = mkdtempSync(join(tmpdir(), 'migration-140-'));
