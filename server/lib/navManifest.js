...
export const NAV_COMMANDS = [
  ...
  { id: 'nav.create.universe-builder', path: '/universe-builder', label: 'Universe', section: 'Create', aliases: ['universe', 'universe-builder', 'worldbuilder', 'worldbuild', 'world', 'lore', 'universe-canon', 'canon'], keywords: ['style template', 'sci-fi', 'fantasy', 'concept art', 'batch render', 'variations', 'characters', 'settings', 'objects', 'canon entries'] },
