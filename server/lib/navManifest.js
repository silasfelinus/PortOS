...
export const NAV_COMMANDS = [
  ...
  { id: 'nav.media.queue', path: '/media/queue', label: 'Render Queue', section: 'Create', aliases: ['render-queue', 'queue', 'media-queue', 'media-jobs'], keywords: ['render', 'queue', 'pending', 'jobs', 'pipeline'] },
