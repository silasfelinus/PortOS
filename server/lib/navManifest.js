...
export const NAV_COMMANDS = [
  ...
  { id: 'nav.create.pipeline', path: '/pipeline', label: 'Series', section: 'Create', aliases: ['series', 'pipeline', 'production', 'series-pipeline', 'production-pipeline'], keywords: ['series', 'issue', 'episode', 'comic', 'script', 'prose', 'storyboard', 'narrative', 'workflow'] },
