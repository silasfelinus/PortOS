...
export const NAV_COMMANDS = [
  ...
  { id: 'nav.create.songs', path: '/songs', label: 'Songs', section: 'Create', aliases: ['songs', 'song', 'music', 'a-cappella', 'acappella', 'sing'], keywords: ['song', 'lyrics', 'melody', 'harmony', 'dirge', 'ballad', 'a cappella', 'vocal', 'choir', 'singing', 'arrangement', '500 miles'] },
  { id: 'nav.create.songs-guide', path: '/songs/guide', label: 'Songs Guide', section: 'Create', aliases: ['songs-guide', 'song-guide', 'singing-guide', 'song-learning'], keywords: ['rhythm shapes', 'dirge', 'voice layers', 'harmony', 'notation', 'lead sheet', 'solfege', 'learn song', 'a cappella', 'singing help'] },
  ...
  { id: 'nav.messages.inbox', path: '/messages/inbox', label: 'Inbox', section: 'Brain', aliases: ['messages'] },
  { id: 'nav.messages.drafts', path: '/messages/drafts', label: 'Drafts', section: 'Brain', aliases: ['drafts'] },
