...
const PROMPT_VERSIONS = {
  ...
  'plan-task': 7,      // v7: drop the scheduler's dispatch-time pre-pick / Item Constraint — the agent self-picks its slug in Phase 1 like /claim, so concurrent dispatches can't both target the same first-available item before either has created its claim/<slug> branch
